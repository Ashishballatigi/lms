			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome teacher to e learning system", { header: 'Access Granted' });
									var delay = 1000;
										setTimeout(function(){ window.location = 'dasboard_teacher.php'  }, delay);  
									}else if (html == 'true_student'){
										$.jGrowl("Welcome student to e learning system", { header: 'Access Granted' });
									var delay = 1000;
			...
			<div id="button_form" class="form-signin" >
				...
				<button data-placement="top" title="Sign In as Student" id="signin_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit" style="margin-right:-30px">I`m a Student</button>
