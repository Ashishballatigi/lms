     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="class.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Course</a>
                        </li>
						<li>
						...
						<li>
                            <a href="Students.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Trainees</a>
                        </li>
						<li>
                            <a href="teachers.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Instructors</a>
                        </li>
						<li class="active">
						...
						<li>
                            <a href="school_year.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Financial Year</a>
                        </li>
						<li class="">
